...
(1, '外包官网banner.png,外包官网Banner2.1.png,外包官网banner3.png', 'APP开发,网站开发,运营维护,小程序开发,公众号开发,分销系统开发,吸粉工具开发,任务系统开发,电商平台开发,技术服务支持');
...
(1, 'APP', '益园养车APP', '益园养车展示.png'),
(2, 'APP', '轻听音乐APP', '轻听音乐展示.png'),
(3, 'APP', '茶茶APP', '茶茶展示.png'),
(4, 'APP', '电子商城APP', '电子商城APP展示.png'),
(5, 'APP', '乐高APP', '乐高APP展示.png'),
(6, 'APP', '宜家APP', '宜家APP展示1.png'),
(7, '小程序', '益园养车小程序', '益园养车展示.png'),
(8, '小程序', '轻听音乐小程序', '轻听音乐展示.png'),
(9, '小程序', '茶茶小程序', '茶茶展示.png'),
(10, '小程序', '奶茶类小程序', '奶茶展示.png'),
(11, '小程序', '养生小程序', '养生展示.png'),
(12, '小程序', '素颜美妆小程序', '素颜美妆展示.png'),
(13, 'PC商城', '益园养车', '益园养车展示.png'),
(14, 'PC商城', '轻听音乐', '轻听音乐展示.png'),
(15, 'PC商城', '茶茶', '茶茶展示.png'),
(16, 'PC商城', '奶茶类', '奶茶展示.png'),
(17, 'PC商城', '养生', '养生展示.png'),
(18, 'PC商城', '素颜美妆', '素颜美妆展示.png'),
(19, 'H5', '益园养车H5', '益园养车展示.png'),
(20, 'H5', '轻听音乐H5', '轻听音乐展示.png'),
(21, 'H5', '茶茶H5', '茶茶展示.png'),
(22, 'H5', '奶茶类H5', '奶茶展示.png'),
(23, 'H5', '养生H5', '养生展示.png'),
(24, 'H5', '素颜美妆H5', '素颜美妆展示.png'),
(25, '移动端', '益园养车移动端', '益园养车展示.png'),
(26, '移动端', '轻听音乐移动端', '轻听音乐展示.png'),
(27, '移动端', '茶茶移动端', '茶茶展示.png'),
(28, '移动端', '奶茶类移动端', '奶茶展示.png'),
(29, '移动端', '养生移动端', '养生展示.png'),
(30, '移动端', '素颜美妆移动端', '素颜美妆展示.png'),
(31, 'APP', '奶茶类app', '奶茶展示.png'),
(32, 'APP', '养生app', '养生展示.png'),
(33, 'APP', '素颜美妆app', '素颜美妆展示.png');
...
(1, '电商', '全行业全场景的电商解决方案', '微商城解决方案致力于为零售业提供多渠道电商解决方案，通过自建商城，以及营销系统、分销系统、会员系统帮助企业搭建新一代微商城销售体系，快速实现去中心化流量聚合，客户粉丝沉淀，助力企业快速步入移动电商时代。', 'shopping-icon.png,dinghuo-icon.png,gongying-icon.png', '社交电商,订货系统,供应链系统', '多用户商城 盈利模式丰富-O2O系统 线上线下新零售-多营销机制 抢占电商市场,互联网化转型 对接官网与微信-系统开放模式 拓展生意渠道-分销数字化系统 批发业务电商化,SRM供应商管理 采购管理一体化-DMS分销管理 打通全渠道库存-SCC供应链协同解决数据交换需求'),
...
(1, '益园养车APP', '益园养车展示.png'),
(2, '轻听音乐APP', '轻听音乐展示.png'),
(3, '茶茶APP', '茶茶展示.png'),
(4, '奶茶类APP', '奶茶展示.png'),
(5, '养生APP', '养生展示.png'),
(6, '素颜美妆APP', '素颜美妆展示.png');
